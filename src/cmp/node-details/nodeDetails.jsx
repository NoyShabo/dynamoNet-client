...
export function NodeCard({nodeDetails}) {
    return (
        ...
        <div className="wrapper">
            ...
            <div  className="location-details"><i class="fa-sharp fa-solid fa-location-dot"></i><span> {nodeDetails.location}</span></div>
            <div className="about-me">{nodeDetails.description}</div>
           
            <div className="username">Join Twitter At: {nodeDetails.registrationDateTwitter}</div>
            <div className="stats">
