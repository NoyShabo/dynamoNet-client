...
import { setProject ,removeSelectedProject } from '../../redux/actions/projectActions'
...
export function Project() {
  ...
  const [degreeCentrality, setDegreeCentrality] = useState([{id: "Degree Centrality",data: []}]);
  ...
  return (
    <div className="project-page">
      ...
      {!project ?   "" : (
        ...
        { project.timeRanges.length === 0 ? <div className="small-title-project">No Time Ranges</div> : (
